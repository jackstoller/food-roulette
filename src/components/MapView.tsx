...
export default function MapView({ 
  ...
  return (
    ...
    >
      <div className="relative w-full h-full bg-gray-200 overflow-hidden">
        <APIProvider apiKey={GOOGLE_MAPS_API_KEY}>
          <Map
            ...
            gestureHandling={view === 'map-expanded' ? 'greedy' : 'none'}
          ...
          >
            ...
            {/* Show radius circle */}
            <RadiusCircle center={mapCenter} radiusKm={currentRadius} />
            ...
            <div className="absolute top-6 left-4 right-4 flex flex-col gap-3 z-50 animate-fade-in-down">
              <div className="bg-white/95 backdrop-blur p-3 rounded-xl shadow-lg">
                ...
                <p className="text-[10px] text-gray-500 mt-0.5">
                  Drag map to adjust • This location will be used for search
                </p>
              </div>
      ...
      <div className={`absolute bottom-0 left-0 w-full h-32 bg-linear-to-t from-gray-50 to-transparent pointer-events-none ${
