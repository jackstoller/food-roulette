    ...
    return (
        <div className='mb-8'>
            ...
            <div className='relative -mr-6'>
                ...
                >
                    {cuisines.map((c) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl shadow-sm transition-all border-2 ${
                                        isSelected
                ...
                {showArrow && (
                    <div className='absolute right-0 top-4 bottom-6 flex items-center pointer-events-none bg-linear-to-l from-gray-50 via-gray-50/80 to-transparent w-20 transition-opacity duration-300'>
