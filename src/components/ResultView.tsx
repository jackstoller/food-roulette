...
export default function ResultView({
    ...
    const [imageSrc, setImageSrc] = useState(() =>
        place.image && place.image.trim().length > 0
            ? place.image
            : FALLBACK_IMAGE
    );
        ...
        <div className='fixed inset-0 bg-gray-50 z-50 overflow-y-auto animate-slide-up'>
            <div className='relative h-[45vh] w-full'>
                ...
                <div className='absolute bottom-6 left-6 right-6 text-white'>
                    ...
                    <h1 className='text-4xl font-black leading-tight mb-3 drop-shadow-md'>
                        {place.name}
                    </h1>
            ...
            <div className='p-6 pb-32'>
                <div className='flex items-start gap-4 mb-8 bg-white p-4 rounded-xl shadow-sm border border-gray-100'>
                    ...
                    <div>
                        ...
                        <p className='text-gray-500 text-sm mt-1'>
                            {(filters.radius - 1.2).toFixed(1)} km away from
                            your location
                        </p>
                    </div>
                </div>
                ...
                <div className='bg-orange-50 rounded-2xl p-6 border border-orange-100'>
                    ...
                    <p className='text-orange-900/70 text-sm leading-relaxed'>
                        ...
                        <strong>{cuisineDescription}</strong>. Highly rated by{' '}
                        {place.reviews} locals and within your budget range.
                    </p>
                </div>
            </div>
