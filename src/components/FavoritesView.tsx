...
export default function FavoritesView({ onBack }: FavoritesViewProps) {
  const mockFavorites: Favorite[] = [
    ...
    { id: 3, name: 'The Burger Joint', cuisine: '🍔 American', rating: 4.9 },
  ];
    ...
    <div className="flex-1 overflow-y-auto custom-scrollbar px-6 py-4">
      <div className="space-y-3">
        {mockFavorites.map((fav) => (
          <div key={fav.id} className="bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-xl border border-yellow-200 hover:shadow-md transition">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <div className="text-2xl font-black text-yellow-600">{fav.rating}</div>
