...
type MenuView = 'main' | 'pastRolls' | 'favorites' | 'about';
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-slide-up flex flex-col max-h-[90vh] overflow-hidden">
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar px-6 py-4">
              <div className="space-y-1">
                <button onClick={() => setView('pastRolls')} className="w-full flex items-center gap-4 p-4 hover:bg-orange-50 rounded-xl transition text-left group">
                ...
                <button onClick={() => setView('favorites')} className="w-full flex items-center gap-4 p-4 hover:bg-yellow-50 rounded-xl transition text-left group">
                ...
                <button onClick={() => setView('about')} className="w-full flex items-center gap-4 p-4 hover:bg-blue-50 rounded-xl transition text-left group">
        ...
        {view === 'pastRolls' && <PastRollsView onBack={() => setView('main')} />}

        {view === 'favorites' && <FavoritesView onBack={() => setView('main')} />}
