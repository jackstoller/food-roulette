...
export default function App() {
    ...
    return (
        ...
        ${
            view === 'rolling' || view === 'result' || view === 'empty'
                ? 'translate-y-full'
                : ''
        }
        `}
            >
                ...
                <div className='flex-1 overflow-y-auto pb-24 px-6 pt-2 custom-scrollbar'>
                    <div className='mb-6'>
                        ...
                        <p className='text-gray-500 mt-1 font-medium text-sm'>
                            Feeling indecisive? Let fate decide.
                        </p>
                    </div>
                    ...
                    <div className='border-t border-gray-200 pt-6 mb-8'>
                        ...
                        >
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <ChevronLeft
                                    className={`w-4 h-4 group-hover:text-orange-500 transition-transform ${
                                        showMoreOptions
                                            ? 'transform rotate-90'
                                            : 'transform -rotate-90'
                                    }`}
                ...
                <div className='absolute bottom-0 left-0 w-full p-6 bg-linear-to-t from-gray-50 via-gray-50 to-transparent'>
                    <button
                        onClick={() => handleRoll(activeLocation)}
                    ...
                    >
                        ...
                        <span className='relative z-10 flex items-center gap-2'>
                            ROLL THE DICE{' '}
                            <Dice5 className='w-6 h-6 group-hover:rotate-180 transition-transform duration-500' />
                        </span>
                    </button>
                </div>
            </div>
            ...
            {view === 'result' && selectedPlace && (
                <ResultView
                    ...
                    filters={filters}
                    onBack={handleBack}
                    onReroll={() => handleReroll(activeLocation)}
                    onOpenMaps={openMaps}
                />
            )}
